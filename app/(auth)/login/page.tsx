            ...
            <motion.div variants={fadeIn} initial="hidden" animate="visible" className="w-full max-w-[400px]">
                <div className="flex flex-col items-center gap-4 mb-6">
                    ...
                    <div className="text-center">
                        <h1 className="text-2xl font-bold tracking-tight text-text-primary">Welcome to Cadence</h1>
                        <p className="mt-1.5 text-base text-text-secondary">Sign in to start your tasks</p>
                    </div>
                </div>
                ...
                <div className="bg-bg-primary border border-border rounded-4xl shadow-elev-3 p-6 flex flex-col gap-3.5">
                    ...
                    <form onSubmit={handleEmailLogin} className="flex flex-col gap-3.5">
                        ...
                        <div className="relative">
                            <Input type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} icon={<Lock className="w-[18px] h-[18px]" />} required />
